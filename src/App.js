...
import { sortData, prettyPrintStar } from "./util.js";
...
function App() {
      ...
      await fetch("https://disease.sh/v3/covid-19/countries")
        ...
        .then((data) => {
          const countries = data.map((country) => ({
            name: country.country, // United State , United Kingdom, India
            value: country.countryInfo.iso3, // USA, UK, IND
          }));
  ...
  const onCountryChange = async (e) => {
    ...
    // Dropdown Country tarnary oparetor //
    const url =
